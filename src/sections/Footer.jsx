...
const socials = [
  ...
  },
  {
    Icon: FaLinkedin,
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/sonu-raj-6a799530a/",
  },
  {
    Icon: FaGithub,
    label: "GitHub",
    href: "https://github.com/sonuraj-dev",
  },
];
...
<div className="flex gap-5 text-2xl md:text-3xl">
  {socials.map(({ Icon, label, href }) => (
    <motion.a href={href}
      ...
      whileTap="tap"
      aria-label={label}
      className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 inline-flex items-center justify-center"
    >
      <Icon />
    </motion.a>
  ))}
...
&copy; {new Date().getFullYear()} Sonu Raj. All rights reserved.
</p>
</motion.div>
</footer>
)
